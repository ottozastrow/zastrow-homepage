      ...
      {flashImage && (
        <div className="flash-overlay" role="status" aria-live="polite">
          <img
            ...
            src={`data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='640' height='360' viewBox='0 0 640 360'><defs><linearGradient id='g' x1='0' x2='1' y1='0' y2='1'><stop offset='0' stop-color='%23222'/><stop offset='1' stop-color='%23555555'/></linearGradient></defs><rect width='640' height='360' fill='url(%23g)'/><g transform='translate(320 180)'><circle r='90' fill='%23ffffff' opacity='0.08'/><circle r='70' fill='none' stroke='%23ffffff' stroke-width='6'/><circle cx='-25' cy='-20' r='8' fill='%23ffffff'/><circle cx='25' cy='-20' r='8' fill='%23ffffff'/><path d='M-30 20 Q0 40 30 20' stroke='%23ffffff' stroke-width='6' fill='none' stroke-linecap='round'/><rect x='-10' y='25' width='20' height='18' rx='4' fill='%23ff6b6b'/><path d='M-10 34 H10' stroke='%23ffffff' stroke-width='4' stroke-linecap='round'/></g><text x='50%' y='85%' fill='%23ffffff' font-size='20' font-family='Arial, sans-serif' text-anchor='middle'>${flashImage.toUpperCase()}</text></svg>`}
          />
        </div>
      )}
    </main>
